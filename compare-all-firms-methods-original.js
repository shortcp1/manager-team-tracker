...
console.log('🏆 MULTI-FIRM METHODOLOGY COMPARISON (ORIGINAL - BASIC SELECTORS)');
...
async function webScrapingForFirm(firm, scrapeId) {
  ...
  try {
    ...
    const CARD_NAME_SEL = 'h2.ink__title, h3.ink__title, [itemprop="name"], .team-card h2, .team-card h3, .person-card h2, .person-card h3, a[href*="/people/"]';
